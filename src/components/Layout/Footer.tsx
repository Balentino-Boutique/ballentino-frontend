  ...
  return (
    <footer className="bg-black text-white py-12 font-melodrama">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="font-melodrama text-2xl mb-4">Ballentino</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li><Link href="/shop?newArrival=true" className="hover:text-accent transition-colors">New Arrivals</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300">
            <li><Link href="https://instagram.com/Ballentino" className="hover:text-accent transition-colors">Instagram</Link></li>
            <li><Link href="https://facebook.com/Ballentino" className="hover:text-accent transition-colors">Facebook</Link></li>
            <li><Link href="https://twitter.com/Ballentino" className="hover:text-accent transition-colors">Twitter</Link></li>
            <li><Link href="https://pinterest.com/Ballentino" className="hover:text-accent transition-colors">Pinterest</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 pt-8 border-t border-white/20">
        <p className="text-center text-gray-400 text-sm">
          © {new Date().getFullYear()} Ballentino. All rights reserved.
        </p>
      </div>
    </footer>
  );
